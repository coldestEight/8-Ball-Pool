...
SWIGINTERN PyObject *_wrap_phylib_new_coord(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  double arg1 ;
  double arg2 ;
  double val1 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "phylib_new_coord", 2, 2, swig_obj)) SWIG_fail;
  ecode1 = SWIG_AsVal_double(swig_obj[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "phylib_new_coord" "', argument " "1"" of type '" "double""'");
  } 
  arg1 = (double)(val1);
  ecode2 = SWIG_AsVal_double(swig_obj[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "phylib_new_coord" "', argument " "2"" of type '" "double""'");
  } 
  arg2 = (double)(val2);
  result = phylib_new_coord(arg1,arg2);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "phylib_new_coord", _wrap_phylib_new_coord, METH_VARARGS, NULL},
